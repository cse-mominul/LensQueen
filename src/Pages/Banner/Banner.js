...
import silderPic2 from '../../Assets/s2.jpg'
import './Banner.css'
const Banner = () => {
    return (
        <div>
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <img src={silderPic1} className=" w-full rounded-xl" />
    </div>
  ...
  <div className='carousel-img w-full'>
    <img src={silderPic2} className=" w-full rounded-xl" />
    </div>
    <div className="absolute flex justify-end transform -translate-y-1/2 left-24 top-1/4">
      <h3 className='titleStyle'>Lens Queen</h3>
    </div>
    <div className="absolute flex justify-end transform -translate-y-1/2 w-2/5 left-24 top-1/2">
      <p className='ParagraphStyle2'>Save Your Memories With Us</p>
    </div>
    <div className="absolute flex justify-start transform -translate-y-1/2 w-2/5 left-24 top-3/4">
    <button className="btn btn-outline mr-5 btn-accent BtnClass">Login</button>
    <button className="btn btn-active btn-accent">Register</button>
